...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        if W is None:
            ...
            print(type(W),W.shape,type(W[0]),W[0].shape)
...
class myMLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out, n_hiddenLayers,parameters = None):
        ...
        for i in xrange(n_hiddenLayers):
            ...
            if parameters != None:
                ...
                weight_matrix,bias = parameters[2*(i)],parameters[2*(i)+1]
                print(i, 'hidden layer :', weight_matrix.shape,bias.shape)
            else:
...
def train_nn(train_model, validate_model, test_model,
    ...
    print('validation_frequency min(n_train_batches, patience // 2) ', validation_frequency)
